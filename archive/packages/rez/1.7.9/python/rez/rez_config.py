...
class Resolver():
	...
	def resolve(self, pkg_reqs, no_os=False, no_path_append=False, is_wrapper=False, \
		...
		# TZ: this appends a windows style export PATH=$PATH:c:/rez_server/packages/rez/1.7.0/bin
...
# 			env_cmds.append("export PATH=$PATH:%s" % str(':').join(sys_paths))
	...
	def resolve_base(self, pkg_reqs):
		...
		# TZ : env_cmds.append("export PATH=")
		env_cmds.append("export PATH=/usr/local/bin:/bin:$REZ_PATH/bin")
		# TZ : env_cmds.append("export REZ_USED=" + rez_filesys._g_rez_path)
		env_cmds.append("export REZ_USED=$REZ_PATH")
		...
		# TZ: env_cmds.append("export PYTHONPATH=%s/python" % rez_filesys._g_rez_path)
		env_cmds.append("export PYTHONPATH=$REZ_PATH/python"	)
